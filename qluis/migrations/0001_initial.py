...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('start', models.DateField(default=django.utils.timezone.now, verbose_name='start date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('external_card', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='qluis.ExternalCard')),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to.', through='qluis.Membership', to='qluis.QGroup', verbose_name='groups')),
                ('gsuite_accounts', models.ManyToManyField(blank=True, to='qluis.GSuiteAccount')),
        ...
        migrations.AddField(
            ...
            name='group',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='qluis.QGroup'),
        ),
        migrations.AddField(
            model_name='membership',
            name='person',

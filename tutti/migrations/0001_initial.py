# Generated by Django 2.2.5 on 2020-02-16 18:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to.', to='tutti.QGroup', verbose_name='groups')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='tutti.QGroup')),
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='tutti.Person')),
            ],
        ),
        migrations.CreateModel(
            name='User',
